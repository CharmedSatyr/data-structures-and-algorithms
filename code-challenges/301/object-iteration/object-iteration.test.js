...
const getHouses = arr => arr.map(o => o.house);
...
const houseSize = arr => {
  ...
  arr.forEach(o => {
    ...
    if (o.children) {
      members += o.children.length;
    }
    sizes.push({ house: o.house, members });
  });
  return sizes;
};
...
const houseSurvivors = arr => {
  ...
  arr.forEach(o => {
    ...
    if (o.spouse && !deceasedSpouses.includes(o.spouse)) {
      members++;
    }
    if (o.children) {
      members += o.children.length;
    }
    survivors.push({ house: o.house, members });
  });
